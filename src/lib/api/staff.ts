    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while creating a Staff',
      );
    }
    throw error;
  }
...
const updateStaff = async (data: UpdateStaff) => {
  ...
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while updating a Staff',
      );
    }
    throw error;
  }
...
const getAllStaff = async ({token, page, limit}: PaginationParams) => {
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while retireving all Staff',
      );
    }
    throw error;
  }
...
const searchStaff = async ({token, query, page, limit}: PaginationParams) => {
  try {
    const res = await api.get('/staff', {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while searching for Staff',
      );
    }
    throw error;
  }
