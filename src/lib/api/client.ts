    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while creating a Client',
      );
    }
    throw error;
  }
...
const updateClient = async (data: UpdateClient) => {
  ...
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while updating a Client',
      );
    }
    throw error;
  }
...
const getAllClient = async ({token, page, limit}: PaginationParams) => {
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while retireving all Client',
      );
    }
    throw error;
  }
...
const searchClient = async ({token, query, page, limit}: PaginationParams) => {
  try {
    const res = await api.get('/clients', {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while searching for Client',
      );
    }
    throw error;
  }
...
const deleteClient = async (data: IdAndToken) => {
  ...
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message ||
          'Something went wrong while deleting Client',
      );
    }
    throw error;
  }
