...
import { createMaharaj , updateMaharaj , getAllMaharaj , getMaharajById , deleteMaharaj , searchMaharaj} from '../../api/maharaj';
...
const useGetMaharajById = (data: IdAndToken) => {
    ...
    return useQuery({
        queryKey: [
            MAHARAJ_KEYS.GET_MAHARAJ_BY_ID,
            id,
        ],
...
export { useCreateMaharaj , useDeleteMaharaj , useGetMaharajById , useGetAllMaharaj ,useSearchMaharaj , useUpdateMaharaj};
