...
import { createStaff, updateStaff, getAllStaff, getStaffById, deleteStaff, searchStaff } from '../../api/staff';
...
export { useCreateStaff, useDeleteStaff, useGetStaffById, useGetAllStaff, useSearchStaff, useUpdateStaff };
